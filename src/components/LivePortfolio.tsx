...
interface Props {
  initialPortfolio: PortfolioContent | null;
  initialProjects: Project[];
}

export default function LivePortfolio({ initialPortfolio, initialProjects }: Props) {
  const [portfolio, setPortfolio] = useState<PortfolioContent | null>(initialPortfolio);
